...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i>0975603230</span>
                         <span class="date-icon"><i class="fa fa-calendar-plus-o"></i> 8:00 AM - 00:00 PM (all day)</span>
                         <span class="email-icon"><i class="fa fa-envelope-o"></i> <a href="#">loveaoe33@gmail.com</a></span>
                    </div>
     ...
     <section id="appointment" data-stellar-background-ratio="3">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <img src="ChugenMain/main/images/appointment-image.jpg" class="img-responsive" alt="">
                    </div>
                         ...
                         <div class="footer-thumb"> 
                              ...
                              <div class="latest-stories">
                                   <div class="stories-image">
                                        <a href="#"><img src="ChugenMain/main/images/news-image.jpg" class="img-responsive" alt=""></a>
                                   </div>
     ...
     <!-- SCRIPTS -->
     <script src="ChugenMain/main/js/jquery.js"></script>
     <script src="ChugenMain/main/js/bootstrap.min.js"></script>
     <script src="ChugenMain/main/js/jquery.sticky.js"></script>
     <script src="ChugenMain/main/js/jquery.stellar.min.js"></script>
     <script src="ChugenMain/main/js/wow.min.js"></script>
     <script src="ChugenMain/main/js/smoothscroll.js"></script>
     <script src="ChugenMain/main/js/owl.carousel.min.js"></script>
     <script src="ChugenMain/main/js/custom.js"></script>
